...
class RedisSpec extends FlatSpec with Matchers {
  "Redis object" should "should have an set and get function" in {
    ...
    Redis.get(r, "my_feature") shouldEqual None
    Redis.set(r, "my_feature", "true||100")
    Redis.get(r, "my_feature") shouldEqual Some("true||100")
    r.del("molasses_my_feature")
  }

  "Redis object" should "should have an activate function that sets the value to 100" in {
    val r = new RedisClient("localhost", 6379)
    Redis.activate(r, "activate_feature")
    r.get("molasses_activate_feature") shouldEqual Some("true||100")
    r.del("molasses_activate_feature")
  }

  "Redis object" should "should have an deactivate function that sets the value to 0" in {
    val r = new RedisClient("localhost", 6379)
    Redis.activate(r, "activate_feature")
  ...
  "Redis object" should "should have an activate function that sets the value to a percentage" in {
    val r = new RedisClient("localhost", 6379)
  ...
  "Redis object" should "should have an activate function that sets the value to a list of users" in {
    val r = new RedisClient("localhost", 6379)
  ...
  "Redis object" should "should have an activate function that sets the value to a user group" in {
    val r = new RedisClient("localhost", 6379)
  ...
  "Redis object" should "should have an activate function that sets the value to a list of user ids" in {
    val r = new RedisClient("localhost", 6379)
  ...
  "Redis object" should "should run get feature and return that feature " in {
    val r = new RedisClient("localhost", 6379)
    Redis.activate(r, "activate_feature", List(1, 2, 3))
